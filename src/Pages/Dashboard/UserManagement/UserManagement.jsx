...
import { ShieldCheck, ShieldX, Trash2, UserCog, UserPlus } from 'lucide-react';
                            ...
                            {users.map((user, i) => (
                                <tr key={user._id} className="border-b hover:bg-gray-50 transition">
                                    ...
                                    <td className="p-4 text-right flex justify-end gap-2">
                                        <button className="border px-3 py-1 rounded"><UserPlus size={18} /> </button>
                                        <button className="border px-3 py-1 rounded"><Trash2 size={18} /></button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
