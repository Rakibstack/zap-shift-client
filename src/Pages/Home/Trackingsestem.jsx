...
const Trackingsestem = () => {
    ...
    return (
        <div className='w-11/12 mx-auto container py-5'>
            ...
            <div className='border-b border-dashed border-secondary mb-5'>
                <div className='sm:flex justify-center items-center gap-8 p-6 bg-white rounded-2xl mb-4'>
                    <img className='w-30 mb-6 mx-auto' src={livetrack}  />
                ...
                <div className='sm:flex justify-center items-center gap-8 p-6 bg-white rounded-2xl mb-4'>
                    <img className='w-30 mb-6 mx-auto' src={safedelivary}  />
                    <div className='border-l border-dashed border-secondary pl-5'>
                ...
                <div className='sm:flex justify-center items-center gap-8 p-6 bg-white rounded-2xl mb-8'>
                    <img className='w-30 mb-6 mx-auto' src={safedelivary}  />
                    <div className='border-l border-dashed border-secondary pl-5'>
                        <h2 className='text-xl font-bold text-secondary mb-2'>24/7 Call Center Support</h2>
                        <p className='text-[#606060]'>Our dedicated support team is available around the clock to assist you with any questions,guarantees safe updates, or delivery concerns—anytime you need us.</p>
                    </div>
                </div>
